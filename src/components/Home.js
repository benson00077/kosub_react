      ...
      <div className="content-section">
        ...
        <div className="apps-card">
          ...
          <div className="app-card">
            ...
            <div className="app-card__subtext">Goblins episode 1-5</div>
          ...
          <div className="app-card">
            ...
            <div class="app-card__subtext">教科書上剪不斷理還亂，文法太多就不該用死背的。韓國人就能很自然的知道什麼特定情況要用哪種文法直接表達，因為他們從小都是按照上下文、語境來學習。 </div>
