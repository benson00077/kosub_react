  ...
  return (
    <>
      ...
      <div className="mt-5">
        ...
        <div>
          <Link to={NAV.ABOUT.path} className={linkClassName + activeNavClassName(NAV.ABOUT.path)}>
      ...
      <div className="mt-5">
        ...
        <div>
          {isLoggedIn && (
            <Link to={NAV.FAVORITE.path} className={linkClassName + activeNavClassName(NAV.FAVORITE.path)}>
              <h4 class="text-gray-300">{NAV.FAVORITE.title}</h4>
            </Link>
          )}

          {!isLoggedIn && (
            <Link to={NAV.LOGIN.path} className={linkClassName + activeNavClassName(NAV.LOGIN.path)}>
              <svg class="fill-slate-50 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          {!isLoggedIn && (
            <Link to={NAV.REGISTER.path} className={linkClassName + activeNavClassName(NAV.REGISTER.path)}>
