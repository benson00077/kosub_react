...
function ApiButtonsToolKit() {
  ...
  return (
    <>
      ...
      >
        <svg class="w-5 h-5" viewBox="0 0 20 20" style={{ fill: 'rgba(218, 46, 136, 0.75)' }}>
          <path d="M10 3.22l-.61-.6a5.5 5.5 0 00-7.78 7.77L10 18.78l8.39-8.4a5.5 5.5 0 00-7.78-7.77l-.61.61z" />
        </svg>
        <h4 class="text-gray-300">Favorite</h4>
      </div>
      <div
        className={linkClassName}
        onClick={() => {
          //TODO: if sentencesID_SelectedList > 0, button status be active / clickable
          //SentencebookPush(sentencesID_SelectedList)
        }}
      >
        <svg class="w-5 h-5" viewBox="0 0 20 20" style={{ fill: 'rgba(80, 250, 240, 0.5)' }}>
