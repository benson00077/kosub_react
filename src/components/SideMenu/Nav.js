  ...
  return (
    <>
      ...
      <div className="mt-5">
        ...
        <div>
          <Link to="/about" className={linkClassName}>
            ...
            <h4 class="text-gray-300">About</h4>
          </Link>
          <Link to="/search" className={linkClassName}>
            ...
            <h4 class="text-gray-300">Search</h4>
          </Link>
        </div>
      </div>
      ...
      <div className="mt-5">
        ...
        <div>
          {isLoggedIn && (
            <Link to="/mysentences" className={linkClassName}>
              <h4 class="text-gray-300">My Setences</h4>
            </Link>
          )}
          ...
          {!isLoggedIn && (
            <Link to="/login" className={linkClassName}>
              ...
              <h4 class="text-gray-300">Log in</h4>
            </Link>
          )}
          ...
          {!isLoggedIn && (
            <Link to="/register" className={linkClassName}>
              ...
              <h4 class="text-gray-300">Create</h4>
            </Link>
          )}
        </div>
      </div>
