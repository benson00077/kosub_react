...
function ModalBoard({ closeCb, title, speechesKo, speechesZh }) {
  return (
    <>
      {/* <!-- Main modal --> */}
      <div class="flex justify-center items-center top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div onClick={(e) => e.stopPropagation()} class="relative w-full max-w-2xl max-h-full">
          {/* <!-- Modal content --> */}
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
              <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">{speechesKo}</p>
              <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">{speechesZh}</p>
            </div>
            {/* <!-- Modal footer --> */}
